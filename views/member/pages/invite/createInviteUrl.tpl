                ...
                <div class="register-form" style="padding: 30px 0;">
                    <form class="layui-form" action="">
                      {#  <div class="layui-form-item">
                            ...
                            <button class="layui-btn" id="createBtn" onclick="return false" lay-submit="" lay-filter="create">{{ Lang.btn_create_link || "生成链接" }}</button>
                        </div>#}
...
{% block js_assets %}
    ...
    <script>
        ...
        {#accountHtml += '<option value="{{ ac.account_type }}" selected>{{ ac.account_no }}-'+accountTypeMap[{{ ac.account_type }}]+'</option>';#}
        {#{% endfor %}#}
//        $('select[name="account_type"]').html(accountHtml);
