                        ...
                        <form class="layui-form"  action="">
                            <div class="layui-form-item" style="margin-bottom: 0">
                                <div class="layui-inline">
                                    <label class="layui-form-label"style="width: 160px; padding: 9px 5px;">{{ Lang.form_label_trade_time || "返佣时间" }}</label>
                                ...
                                <div class="layui-inline">
                                    <input type="text" name="source_account_full_name"  placeholder="{{ Lang.table_lower_level_name || "下级姓名" }}" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline">
                                    <input type="text" name="source_account_no"  placeholder="{{ Lang.table_lower_level_account || "下级账号" }}" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline">
    ...
    <script>
        ...
        layui.use(['form','laydate','table'], function(){
            ...
            tableIns = table.render({
                elem : '#tra'
                ,url : '/member/rebates/trade/list'
                ,method: 'post'
                ,cellMinWidth : 80
                ,page:true
                ,cols : [[
                    {field:'gmt_create', title:'{{ Lang.table_change_time_1 || "返佣时间" }}', align: 'center', templet: function (d) {
                            if(d.statistics){
                                return "{{ Lang.table_total_text || "合计" }}";
                            }
                            return d.gmt_create;
                        }}
                    ,{field:'source_account_no', title:'{{ Lang.table_lower_level_account || "下级账号"}}', align: 'center'}
                    ,{field:'source_account_full_name', title:'{{ Lang.table_lower_level_name || "下级姓名"}}', align: 'center'}
                    ...
                    , {
                        field: 'rateRebate', title: '{{Lang.table_rate_rebate || "返佣比率" }}', align: 'center', templet: function (d) {
                            ...
                            var rate = d.amount / d.trading_volume;
                    ...
                    ,{field:'amount', title:'{{ Lang.table_commission_amount || "返佣金额(USD)"}}', align: 'center', templet: function (d) {
                            return fmoney( (d.amount / 100 ||  0).toFixed(2),2);
                        }}
                ]]
                , response: {
